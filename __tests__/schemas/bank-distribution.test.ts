  ...
  const BANCOS_SISTEMA = [
    {
      id: "boveda_monte",
      nombre: "Bóveda Monte",
      recibeIngresosVenta: true,
      permiteIngresoManual: false,
    },
    {
      id: "boveda_usa",
      nombre: "Bóveda USA",
      recibeIngresosVenta: false,
...
describe("🔄 TRANSFERENCIAS ENTRE LOS 7 BANCOS", () => {
  ...
  test("Validación: No permite origen = destino", () => {
    ...
    expect(() => ejecutarTransferencia(banco, banco, 10000, "Test")).toThrow(
  ...
  test("Validación: No permite monto <= 0", () => {
    ...
    expect(() => ejecutarTransferencia(origen, destino, 0, "Test")).toThrow(
      "Monto debe ser mayor a 0"
    )
    expect(() => ejecutarTransferencia(origen, destino, -100, "Test")).toThrow(
      "Monto debe ser mayor a 0"
    )
  })
  ...
  test("Validación: No permite capital insuficiente", () => {
    ...
    expect(() => ejecutarTransferencia(origen, destino, 10000, "Test")).toThrow(
