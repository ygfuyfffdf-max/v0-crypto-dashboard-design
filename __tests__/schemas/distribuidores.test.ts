...
describe("Distribuidores Schema - Validaciones", () => {
  describe("validarDistribuidor", () => {
    ...
    it("❌ debe rechazar email inválido", () => {
      ...
      expect(result.success).toBe(false)
      if (!result.success) {
        expect(result.errors?.some((e: string) => e.includes("email") || e.includes("Email"))).toBe(
          true
        )
      }
    })
    ...
    it("✅ debe aceptar varios formatos de teléfono válidos", () => {
      const formatos = ["+52 555 123 4567", "(555) 123-4567", "5551234567", "+1-800-555-1234"]
  ...
  describe("generarKeywordsDistribuidor", () => {
    it("✅ debe generar keywords desde nombre", () => {
      const keywords = generarKeywordsDistribuidor("Distribuidor Alpha", undefined, undefined)
    ...
    it("✅ debe incluir empresa en keywords", () => {
      const keywords = generarKeywordsDistribuidor("PACMAN", "Distribuidora PACMAN S.A.", undefined)
    ...
    it("✅ debe eliminar duplicados", () => {
      const keywords = generarKeywordsDistribuidor("Test Test", "Test Company", undefined)
    ...
    it("✅ debe ignorar palabras muy cortas", () => {
      const keywords = generarKeywordsDistribuidor("A B CD", undefined, undefined)
