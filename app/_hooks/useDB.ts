...
export function useRealtime(_channel: string, options: UseRealtimeOptions = {}) {
...
export function useOptimistic<T extends { id: string }>(options: UseOptimisticOptions<T>) {
