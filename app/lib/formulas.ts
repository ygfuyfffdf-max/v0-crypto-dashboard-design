...
export function calcularDistribucionGYA(datos: DatosVentaCalculo): DistribucionGYA {
  ...
  // Lógica CORE de GYA - Distribución entre 3 bancos
...
export function calcularVentaCompleta(datos: DatosVentaCalculo): ResultadoVenta {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  const totalVenta = precioVenta * cantidad // Lo que PAGA el cliente
 ...
 */
export function calcularDeudaCliente(totalVentas: number, totalPagado: number): number {
 ...
 * @returns Deuda pendiente
 */
export function calcularDeudaDistribuidor(totalOrdenes: number, totalPagado: number): number {
 ...
 */
export function validarStock(stockActual: number, cantidadSolicitada: number): boolean {
 ...
 */
export function calcularMargenPorcentaje(precioVenta: number, costo: number): number {
