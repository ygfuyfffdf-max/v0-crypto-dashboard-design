...
export const INFINITY_GRADIENTS = {
  ...
  holographic:
    'linear-gradient(90deg, #FFD700 0%, #EC4899 25%, #8B5CF6 50%, #10B981 75%, #FFD700 100%)',
...
export const INFINITY_SHADOWS = {
  ...
  heroCard:
    '0 25px 50px rgba(0, 0, 0, 0.5), 0 50px 100px rgba(0, 0, 0, 0.4), 0 100px 200px rgba(0, 0, 0, 0.3), inset 0 1px 1px rgba(255, 255, 255, 0.05)',

  // Colored Glows
  glowGold:
    '0 0 20px rgba(255, 215, 0, 0.6), 0 0 40px rgba(255, 215, 0, 0.3), 0 0 80px rgba(255, 215, 0, 0.15)',
  glowViolet:
    '0 0 20px rgba(139, 92, 246, 0.6), 0 0 40px rgba(139, 92, 246, 0.3), 0 0 80px rgba(139, 92, 246, 0.15)',
  glowEmerald:
    '0 0 20px rgba(16, 185, 129, 0.6), 0 0 40px rgba(16, 185, 129, 0.3), 0 0 80px rgba(16, 185, 129, 0.15)',
  glowPlasma:
    '0 0 20px rgba(236, 72, 153, 0.6), 0 0 40px rgba(236, 72, 153, 0.3), 0 0 80px rgba(236, 72, 153, 0.15)',
  glowSapphire:
    '0 0 20px rgba(59, 130, 246, 0.6), 0 0 40px rgba(59, 130, 246, 0.3), 0 0 80px rgba(59, 130, 246, 0.15)',
  glowRuby:
