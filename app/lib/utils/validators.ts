...
// Validación de email
export const emailSchema = z.string().email('Email inválido').or(z.literal(''))
...
// Validación de ID
export const idSchema = z.string().min(1, 'ID requerido').max(100, 'ID demasiado largo')
...
export const gastoSchema = z.object({
  ...
  concepto: z.string().min(1, 'Concepto requerido').max(200),
  categoria: z
    .enum(['operativo', 'administrativo', 'personal', 'transporte', 'servicios', 'otros'])
    .default('operativo'),
