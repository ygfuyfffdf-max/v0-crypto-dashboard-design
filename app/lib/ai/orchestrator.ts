...
// =====================================================================
// CONFIGURACIÓN DE MODELOS - ELEVATED 2025
// =====================================================================

export const AI_MODELS = {
  // xAI Grok (Preferido para análisis financiero)
  GROK_2: 'grok-2-1212',
  GROK_2_LATEST: 'grok-2-latest',
  GROK_3_MINI: 'grok-3-mini-beta',
  GROK_3: 'grok-3-beta', // NEW: Grok 3 full

  // OpenAI (GPT-4.5 y O3)
  GPT_4O: 'gpt-4o',
  GPT_4O_MINI: 'gpt-4o-mini',
  GPT_4_TURBO: 'gpt-4-turbo',
  GPT_4_5: 'gpt-4.5-preview', // NEW: GPT-4.5 preview
  O3_MINI: 'o3-mini', // NEW: O3 reasoning model

  // Anthropic (Claude 3.5+)
  CLAUDE_SONNET: 'claude-3-5-sonnet-20241022',
  CLAUDE_HAIKU: 'claude-3-haiku-20240307',
  CLAUDE_OPUS: 'claude-3-opus-20240229', // NEW: Para análisis complejos

  // Google (Gemini 2.0)
  GEMINI_PRO: 'gemini-1.5-pro',
  GEMINI_FLASH: 'gemini-1.5-flash',
  GEMINI_2_FLASH: 'gemini-2.0-flash', // NEW: Gemini 2.0
  GEMINI_THINKING: 'gemini-2.0-flash-thinking-exp', // NEW: Reasoning

  // GitHub Models (Open Source)
  PHI_4: 'microsoft/Phi-4',
  LLAMA_3: 'meta-llama/Llama-3.2-11B-Vision-Instruct',
  LLAMA_3_405B: 'meta-llama/Llama-3.1-405B-Instruct', // NEW: Largest Llama
  DEEPSEEK_V3: 'deepseek-ai/DeepSeek-V3', // NEW: DeepSeek
  MISTRAL_LARGE: 'mistralai/Mistral-Large-Instruct-2407', // NEW: Mistral
} as const

export const DEFAULT_MODEL = AI_MODELS.GROK_2

// 🏦 FINANCE-OPTIMIZED MODEL ROUTING
export const FINANCE_MODEL_ROUTING = {
  quickQueries: AI_MODELS.GPT_4O_MINI, // Consultas rápidas de saldo
  salesAnalysis: AI_MODELS.GROK_2, // Análisis de ventas
  complexReports: AI_MODELS.CLAUDE_OPUS, // Reportes ejecutivos
  predictions: AI_MODELS.GEMINI_2_FLASH, // Predicciones de flujo
  reasoning: AI_MODELS.O3_MINI, // Razonamiento complejo
}
...
// Mapeo de modelos a proveedores (expandido)
const MODEL_PROVIDERS: Record<string, AIProvider> = {
  ...
  'meta-llama/Llama-3.1-405B-Instruct': 'github',
  'deepseek-ai/DeepSeek-V3': 'github',
  'mistralai/Mistral-Large-Instruct-2407': 'github',
}
...
class AIOrchestrator {
  ...
  async converse(
    ...
    // 2. Generar respuesta
    const response = await this.complete([{ role: 'user', content: transcription }], options)
  ...
  private async tryFallback(
    ...
    const currentProvider =
      options.provider || this.getProviderForModel(options.model || DEFAULT_MODEL)
