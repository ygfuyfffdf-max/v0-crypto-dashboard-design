...
export const BancoIdSchema = z.enum(BANCOS_IDS, {
  errorMap: () => ({
    message:
      'Banco inválido. Usar: boveda_monte, boveda_usa, utilidades, flete_sur, azteca, leftie, profit',
  }),
})
 ...
 */
export const DistribucionGYASchema = z
  .object({
 ...
 */
export const ItemVentaSchema = z
  .object({
  ...
  .refine(
    ...
    {
      message:
        '⚠️ Esta venta generaría utilidad negativa. Aumentar precio de venta o reducir flete.',
      path: ['precioVenta'],
    },
  )
 ...
 */
export const CrearVentaCompletaSchema = z
  .object({
    /** Nombre del cliente */
 ...
 */
export const CrearOrdenCompraCompletaSchema = z
  .object({
...
export const RegistrarIngresoSchema = z.object({
  ...
  bancoDestino: z.enum(BANCOS_OPERATIVOS, {
    errorMap: () => ({
      message:
        'Solo los bancos operativos (Azteca, Leftie, Profit) pueden recibir ingresos directos',
    }),
  }),
  /** Monto del ingreso */
  monto: MontoPositivoSchema,
 ...
 */
export function validarVentaCompleta(
  data: unknown,
): ValidationResult<z.infer<typeof CrearVentaCompletaSchema>> {
 ...
 */
export function validarOrdenCompraCompleta(
  data: unknown,
): ValidationResult<z.infer<typeof CrearOrdenCompraCompletaSchema>> {
 ...
 */
export function validarAbonoCliente(
  data: unknown,
): ValidationResult<z.infer<typeof AbonoClienteSchema>> {
 ...
 */
export function validarPagoDistribuidor(
  data: unknown,
): ValidationResult<z.infer<typeof PagoDistribuidorSchema>> {
...
export function validarTransferencia(
  data: unknown,
): ValidationResult<z.infer<typeof TransferenciaBancosSchema>> {
...
export function validarGasto(
  data: unknown,
): ValidationResult<z.infer<typeof RegistrarGastoSchema>> {
...
export function validarIngreso(
  data: unknown,
): ValidationResult<z.infer<typeof RegistrarIngresoSchema>> {
