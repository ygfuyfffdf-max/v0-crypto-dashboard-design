...
export const distribuidorSchema = z.object({
  ...
  empresa: z.string().max(100, 'El nombre de empresa es demasiado largo').optional(),

  contacto: z.string().max(100, 'El nombre de contacto es demasiado largo').optional(),
...
export const productoSchema = z.object({
  ...
  unidad: z.string().max(20, 'La unidad es demasiado larga').default('pz'),
...
export const ordenCompraSchema = z.object({
  distribuidorId: z
    .string({ required_error: 'Selecciona un distribuidor' })
    .min(1, 'Selecciona un distribuidor'),
...
export const abonoSchema = z.object({
  ...
  comprobante: z.string().max(100, 'El número de comprobante es demasiado largo').optional(),

  notas: z.string().max(300, 'Las notas son demasiado largas').optional(),
})
