...
export const queryKeys = {
  ...
  ventas: {
    ...
    byFecha: (inicio: Date, fin: Date) =>
      ['ventas', 'fecha', inicio.toISOString(), fin.toISOString()] as const,
  },
  ...
  ordenesCompra: {
    ...
    byDistribuidor: (distribuidorId: string) =>
      ['ordenesCompra', 'distribuidor', distribuidorId] as const,
  ...
  movimientos: {
    ...
    byFecha: (inicio: Date, fin: Date) =>
      ['movimientos', 'fecha', inicio.toISOString(), fin.toISOString()] as const,
  },
...
export function getRelatedQueryKeys(
  collection: keyof typeof queryKeys,
  ...
  const relations: Record<string, readonly (readonly string[])[]> = {
    ...
    clientes: [queryKeys.clientes.all, queryKeys.ventas.all],
    distribuidores: [queryKeys.distribuidores.all, queryKeys.ordenesCompra.all],
    ordenesCompra: [
    ...
    bancos: [queryKeys.bancos.all, queryKeys.movimientos.all, queryKeys.dashboard.stats()],
    movimientos: [queryKeys.movimientos.all, queryKeys.bancos.all],
    almacen: [queryKeys.almacen.all, queryKeys.ordenesCompra.all],
  }
