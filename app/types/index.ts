...
export interface OrdenCompra {
  ...
  precioUnitario?: number // Alias de costoPorUnidad
  // Stock tracking
...
export interface Venta {
  ...
  precioVentaUnidad?: number // Alias de precioVenta
  precioCompra?: number // Costo unitario (de la OC) - para calcular ganancia
  precioCompraUnidad?: number // Alias de precioCompra
  // Totales
...
export interface Producto {
  ...
  stockActual: number
  stockMinimo: number
  minimo?: number // Alias de stockMinimo
  stockMaximo?: number
  // Historial
