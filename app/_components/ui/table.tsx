...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-4 text-left align-middle text-xs font-medium text-white/50 [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('px-4 py-3 align-middle text-sm text-white/70 [&:has([role=checkbox])]:pr-0', className)}
    {...props}
  />
))
