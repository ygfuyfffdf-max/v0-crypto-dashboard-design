  ...
  const commands: CommandItem[] = useMemo(
    () => [
      ...
      // Acciones rápidas
      {
        ...
        shortcut: ['⌘', 'N'],
        category: 'action',
        action: () => router.push('/ventas?action=new'),
      },
      {
      ...
      },
      {
        ...
        category: 'action',
        action: () => router.push('/bancos?action=transfer'),
      },
      {
        id: 'action-buscar',
        icon: '🔍',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="glass-panel overflow-hidden rounded-3xl border border-violet-500/30 shadow-2xl"
          style={{
        ...
        >
          ...
          <div className="border-b border-white/5 p-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl border-2 border-violet-500/20 bg-white/5 py-4 pr-6 pl-14 text-white placeholder-gray-400 transition-colors focus:border-violet-500/50 focus:outline-none"
              />
              <div className="absolute top-1/2 right-4 flex -translate-y-1/2 items-center gap-2 text-xs text-gray-400">
                <kbd className="rounded border border-white/10 bg-white/5 px-2 py-1">ESC</kbd>
              </div>
            </div>
          </div>
          ...
          <div className="custom-scrollbar max-h-[60vh] overflow-y-auto p-4">
            {Object.entries(groupedCommands).map(([category, items]) => (
              <div key={category} className="mb-6 last:mb-0">
                <h3 className="mb-3 px-4 text-xs font-medium tracking-wider text-gray-400 uppercase">
                  ...
                  {items.map((cmd, index) => {
                    ...
                    return (
                      <motion.button
                        ...
                        whileHover={{ x: 4 }}
                        whileTap={{ scale: 0.98 }}
                        className={`flex w-full items-center gap-4 rounded-xl px-4 py-3 transition-spring ${
                          isSelected
                            ? 'border-2 border-violet-500/50 bg-violet-500/20'
          ...
          {/* Footer con atajos */}
          <div className="flex items-center justify-between border-t border-white/5 p-4 text-xs text-gray-400">
