...
// ═══════════════════════════════════════════════════════════════════════════════════════════════════
// 💧 LIQUID GLASS CARD — Enhanced Glass with Mouse-Tracking Shine & Animated Borders
// ═══════════════════════════════════════════════════════════════════════════════════════════════════
    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          // Liquid glass background with layered blur
          "bg-white/[0.02] backdrop-blur-md backdrop-brightness-110 backdrop-saturate-150",
          // Subtle border
        ...
        style={{
          // CSS variables for mouse position (used by ::before pseudo-element)
          // @ts-ignore
          "--mx": `${mousePosition.x}%`,
          "--my": `${mousePosition.y}%`,
        }}
      ...
      >
        {/* Animated gradient border (conic gradient that shifts on mouse proximity) */}
        {enableAnimatedBorder && (
          <motion.div
            className="pointer-events-none absolute inset-0 rounded-2xl opacity-0 transition-opacity duration-300 group-hover:opacity-100"
            style={{
              background: `conic-gradient(from 0deg at var(--mx, 50%) var(--my, 50%), ${color.glow} 0deg, transparent 60deg, transparent 300deg, ${color.glow} 360deg)`,
              mask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)",
              maskComposite: "exclude",
              WebkitMaskComposite: "xor",
              padding: "1px",
        ...
        {enableMouseTracking && (
          <motion.div
            ...
            style={{
              background: `radial-gradient(circle 200px at var(--mx, 50%) var(--my, 50%), rgba(255, 255, 255, 0.15) 0%, transparent 70%)`,
            }}
          />
        )}
        ...
        {enableInnerGlow && (
          <motion.div
            ...
            style={{
              background: `radial-gradient(ellipse 80% 60% at 50% 0%, ${color.aurora} 0%, transparent 50%)`,
            }}
          />
        )}
