...
export function AbonoClienteForm({
  ...
  return (
    ...
    >
      <div className="glass-panel rounded-3xl border border-green-500/20 p-8">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-green-500/20 to-emerald-500/20">
            <ArrowDown className="h-8 w-8 text-green-400" />
          </div>
          <h2 className="mb-2 text-2xl font-bold text-white">Recibir Abono</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xl font-bold text-red-400">{formatCurrency(deudaCliente)}</p>
                </div>
              </div>
            </motion.div>
          )}
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 px-6 py-4 font-bold text-white transition-spring hover:scale-105 hover:shadow-lg hover:shadow-green-500/30 disabled:opacity-50 disabled:hover:scale-100"
          >
            {isPending ? (
              <>
...
export function PagoDistribuidorForm({
  ...
  const montoValido =
    (watchedValues.monto || 0) <= deudaDistribuidor && (watchedValues.monto || 0) <= capitalBanco
  ...
  return (
    <motion.div
      ...
      className="mx-auto w-full max-w-lg"
    >
      <div className="glass-panel rounded-3xl border border-orange-500/20 p-8">
        <div className="mb-6 text-center">
          ...
          <h2 className="mb-2 text-2xl font-bold text-white">Pagar a Distribuidor</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white focus:border-orange-500"
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      {distribuidorSeleccionado.empresa || 'Sin empresa'}
                    </p>
                  </div>
                </div>
                <div className="text-right">
                ...
                .map((banco) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Building2 className="h-3 w-3" style={{ color: config?.color }} />
                      </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              min={0}
              step="0.01"
              className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-4 text-center text-2xl font-bold text-white focus:border-orange-500"
            />
            ...
            {watchedValues.monto > deudaDistribuidor && (
              <p className="text-xs text-yellow-400">El monto excede el adeudo</p>
            )}
          </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-red-500 px-6 py-4 font-bold text-white transition-all hover:opacity-90 disabled:opacity-50"
          >
            {isPending ? (
              <>
                <Loader2 className="h-5 w-5 animate-spin" />
