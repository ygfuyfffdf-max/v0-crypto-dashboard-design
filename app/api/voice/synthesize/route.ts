...
async function synthesizeElevenLabs(
  ...
  const voiceId =
    VOICES.elevenlabs[voice as keyof typeof VOICES.elevenlabs] || VOICES.elevenlabs.chronos

  // Configuración de emoción para voice settings
  const emotionSettings: Record<
    string,
...
// TTS con Google
async function synthesizeGoogle(text: string, language: string): Promise<SynthesizeResponse> {
