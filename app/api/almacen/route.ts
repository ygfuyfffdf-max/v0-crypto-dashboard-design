...
export async function GET() {
  try {
    ...
    logger.error('Error fetching almacen:', error as Error, { context: 'API' })
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error('Error creando producto:', error as Error, { context: 'API' })
    return NextResponse.json({ error: 'Error interno' }, { status: 500 })
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.error('Error actualizando producto:', error as Error, { context: 'API' })
    return NextResponse.json({ error: 'Error interno' }, { status: 500 })
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    logger.error('Error eliminando producto:', error as Error, { context: 'API' })
    return NextResponse.json({ error: 'Error interno' }, { status: 500 })
  }
}
