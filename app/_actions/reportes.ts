...
export async function getDashboardResumen() {
  try {
    ...
    logger.error('Error obteniendo resumen dashboard:', error as Error, { context: 'reportes' })
...
export async function getReporteVentas(filtros: FiltrosReporte) {
  try {
    ...
    logger.error('Error generando reporte de ventas:', error as Error, { context: 'reportes' })
...
export async function getReporteBancos(filtros: FiltrosReporte) {
  try {
    ...
    logger.error('Error generando reporte de bancos:', error as Error, { context: 'reportes' })
    return { error: 'Error al generar reporte' }
  }
}
...
export async function getReporteClientes() {
  try {
    ...
    logger.error('Error generando reporte de clientes:', error as Error, { context: 'reportes' })
    return { error: 'Error al generar reporte' }
  }
}
...
export async function getReporteDistribuidores(filtros: FiltrosReporte) {
  try {
    ...
    logger.error('Error generando reporte de distribuidores:', error as Error, {
      context: 'reportes',
    })
    return { error: 'Error al generar reporte' }
  }
...
export async function getReporteAlmacen() {
  try {
    ...
    const productosAgotados = await db.select().from(almacen).where(eq(almacen.cantidad, 0))
    ...
    logger.error('Error generando reporte de almacén:', error as Error, { context: 'reportes' })
    return { error: 'Error al generar reporte' }
  }
}
...
export async function getResumenFinanciero(filtros: FiltrosReporte) {
  try {
    ...
    logger.error('Error generando resumen financiero:', error as Error, { context: 'reportes' })
