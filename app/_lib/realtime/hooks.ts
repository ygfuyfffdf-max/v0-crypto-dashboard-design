 ...
 */
export function useRealtime(queryKey: readonly string[], intervalMs = 2000) {
...
export function useOptimisticMutation<TData, TVariables, TResult>(
  ...
  return useMutation<TResult, Error, TVariables, { previousData: TData | undefined }>({
    mutationFn,
    onMutate: async (variables: TVariables) => {
      ...
      queryClient.setQueryData<TData>(config.queryKey, (old) => config.updateFn(old, variables))
