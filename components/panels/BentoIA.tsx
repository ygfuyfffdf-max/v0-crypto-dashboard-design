...
import { AIAnalyticsOverlay } from "@/components/3d/AIAnalyticsOverlay"
...
import { AIBrainVisualizer } from "@/components/visualizations/AIBrainVisualizer"
...
const SplineBot3D = lazy(() => import("@/components/3d/SplineBot3D").then(m => ({ default: m.SplineBot3D })))
const SplitScreenIA = lazy(() => import("@/components/3d/SplitScreenIA").then(m => ({ default: m.SplitScreenIA })))
const SplineWidget3D = lazy(() => import("@/components/3d/SplineWidget3D").then(m => ({ default: m.SplineWidget3D })))
