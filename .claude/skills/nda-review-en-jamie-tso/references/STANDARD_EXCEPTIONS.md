...
Most workable NDAs include clear exceptions. Missing or unworkable exceptions are a common
negotiation driver.
...
Residuals clauses often function like an exception by permitting use of retained information. Treat
them as separate (see KEY_CLAUSES.md).

## 6) Personal data and regulatory disclosures

If personal data is involved, parties sometimes try to treat privacy compliance as an “exception” to
confidentiality.
...
> **Employment / contractor variation:** carve-outs may be narrowed in employment contexts; ensure
> practicality and compliance with workplace obligations.
