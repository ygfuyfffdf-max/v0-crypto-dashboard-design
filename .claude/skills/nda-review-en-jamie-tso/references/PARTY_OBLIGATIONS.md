...
> **M&A / Due diligence:** non-reliance clauses may be acceptable early, but confirm alignment with
> later transaction documents.

## 3) Mutual NDAs (two-way flow) — out of scope

This skill is designed for **one-way (unilateral)** NDAs. If the NDA is mutual, stop and escalate or
use a separate mutual-NDA review playbook.
...
> **Investor / VC variation:** standstill and no-solicit may be intentionally requested; treat as
> business decision and escalate.
