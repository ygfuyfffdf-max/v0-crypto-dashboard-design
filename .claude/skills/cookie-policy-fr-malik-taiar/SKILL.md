...
description:
  Guide complet pour la rédaction de politiques cookies conformes au RGPD et à la directive
  ePrivacy. Contient les recommandations CNIL 2020, un template de référence et les bonnes
  pratiques. À utiliser lors de la rédaction ou révision d'une politique cookies pour un site web ou
  une application.
---

# Guide des Politiques Cookies

> Version 1.0 - Décembre 2025 Conformité : RGPD + Directive ePrivacy + Lignes directrices CNIL 2020

---

## Vue d'ensemble

La politique cookies informe les utilisateurs sur les cookies et traceurs déposés sur leur appareil.
Elle est distincte de la politique de confidentialité mais peut y être intégrée. Elle doit respecter
...
> **OBLIGATION** : Pour TOUTE information concernant les cookies, le consentement, les durées de
> conservation, les exemptions ou les bonnes pratiques :
>
...
> **LIRE LA SOURCE CNIL** : `assets/CNIL_recommandation_cookies_et_traceurs.pdf` +
> https://www.cnil.fr/fr/cookies-et-autres-traceurs/regles/cookies **IMPORTANT** : La CNIL
> recommande **6 mois** pour le cookie de consentement. Utiliser 6 mois par défaut.
...
>
> Les informations collectées (cookies utilisés, CMP, etc.) servent à **remplir** le template, **pas
> à le réécrire**.
...
> mentions de conformité cookies (CNIL 2020) :
>
...
> Ces sanctions illustrent l'importance d'une politique cookies conforme et d'une bannière
> respectant le principe du refus aussi simple que l'acceptation.
...
1. **Étape 1 - Choisir le template** : Template de référence par défaut, ou template interne de
   l'avocat
...
> **RAPPEL TEMPLATE** : Ne jamais rédiger depuis zéro. Toujours partir du template de référence et
> l'adapter. **RAPPEL DURÉE** : La CNIL recommande **6 mois** pour le cookie de consentement (13
> mois max). Toujours vérifier dans les sources CNIL avant de mentionner une durée.
