...
Un skill Claude pour **évaluer la conformité** ou **rédiger une politique** de signalement des
lanceurs d'alerte conforme au droit français.
...
2. Adapter le template `assets/Template_Politique_Lanceur_Alerte.docx` (éléments variables
   uniquement)
3. Vérifier la conformité avec les références
4. Faire valider par la direction et consulter le CSE

**N'oubliez pas** : Tous les outputs de ce skill doivent être relus par un professionnel du droit
qualifié avant toute utilisation à des fins juridiques.

## AVERTISSEMENT

**CECI N'EST PAS UN AVIS JURIDIQUE.** Ce skill est fourni à des fins d'information et d'éducation
uniquement. Les lois varient selon les juridictions et les circonstances individuelles, et seul un
avocat ou juriste habilité peut fournir un conseil adapté à votre situation spécifique.
